...
import initializ.blog.repositories.CommentRepo;
import initializ.blog.repositories.PostRepo;
import initializ.blog.services.CommentService;
...
private ModelMapper modelMapper;
	...
	Comment com=this.commentRepo.findById(commentId).orElseThrow(()->new ResourceNotFoundException("Commet","Comment Id",commentId));
